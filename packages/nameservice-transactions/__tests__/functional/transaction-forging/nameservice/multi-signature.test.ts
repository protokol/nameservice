...
describe("Nameservice functional tests - Signed with multi signature", () => {
    ...
    it("should broadcast, accept and forge it [3-of-3 multisig]", async () => {
        ...
        const multiSignature = NamespaceTransactionFactory.initialize(app)
        ...
        const multiSignatureFunds = NamespaceTransactionFactory.initialize(app)
